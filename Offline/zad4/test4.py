...
# sprawdzanie czy z wierchołka u jest mozliwy przelot do wierchołka v jest realizowane poprzez sprawdzenie czy dana krawedz nie była już wykorzystana oraz czy po dodaniu tego wierchołka do trasy napodstawie roznicy miedzy elmax i elmin  bedzie mozliwy do ustalenia półap lotu który spełni warunki 
...
def Flight(L,x,y,t):
  ...
  def DFSvisit(L,curV,end,elmin,elmax,flag):
    ...
    if result==True:
      return
    for e in range(n):
      if not visted[e] and (L[e][0]==curV or L[e][1]==curV): 
        if flag:
          elmax=L[e][2]
          elmin=L[e][2] 
        else:
...
L=[(0,1,2000),(0,2,2000),(1,3,2030),(2,3,2000),(3,4,2000),(4,5,1970),(4,6,1970),(5,6,2000),(5,7,2000),(7,8,2000)]
#print(Flight(L,0,7,20))
